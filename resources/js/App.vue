            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-9 offset-lg-3 cta-catalog d-flex flex-column justify-content-center pl-5 pr-5 text-center text-lg-left">
                        <h5 v-if="lang=='ro'">Ai nevoie de o simulare ca sa te<br class="d-none d-lg-block"> convingi ca ai ales bine? Scrie-ne</h5>
                        <h5 v-if="lang=='en'">Do you need a simulation to make sure<br class="d-none d-lg-block"> you’ve choose right? Contact us!</h5>
                ...
                <div class="row">
                    <div class="col-lg-3 pad-left d-flex align-items-center align-items-md-end align-items-lg-start flex-column flex-md-row flex-lg-column footer-col my-5">
                        ...
                        <div class="d-flex flex-column flex-sm-row flex-lg-column">
                            <a v-if="lang == 'ro'" :href="(lang == 'en' ? '/en' :'') + '/info_page'" class="mb-lg-2 mr-4 mr-lg-0 text-center text-sm-left">Date de identificare</a>
                            <a v-else :href="(lang == 'en' ? '/en' :'') + '/info'" class="mb-lg-2 mr-4 mr-lg-0 text-center text-sm-left">Company ID</a>
                            <a v-if="lang == 'ro'" :href="(lang == 'en' ? '/en' :'') + '/info_page#confidentialitate'" class="mb-lg-2 mr-4 mr-lg-0 text-center text-sm-left">Confidentialitate</a>
                            <a v-else :href="(lang == 'en' ? '/en' :'') + '/info#confidentialitate'" class="mb-lg-2 mr-4 mr-lg-0 text-center text-sm-left">Privacy</a>
                            <a :href="(lang == 'en' ? '/en' :'') + '/infoe#cookies'" class="mb-lg-2 mr-4 mr-lg-0 text-center text-sm-left">Cookies</a>
                        </div>
                    </div>
                    <div class="col-lg-9 pt-5 pad-right bk-black white d-flex flex-column pad-left-mobile pl-lg-5">
                        <div class="row">
                            <div class="col-xl-8 mb-5 mb-xl-0">
                                ...
                                <h2 v-else id="footer-h2" class="mb-5 text-center text-md-left">Do you have a pilot project in your mind?</h2>
