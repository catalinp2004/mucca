    ...
    <div v-if="!loading" class="products-filter-wrapper">
        ...
        <div class="filter-menu d-flex flex-column flex-md-row justify-content-between pl-lg-5 mb-4 mb-md-5">
            <div class="breadcrumbs order-2 order-lg-1 pad-left-catalog pl-lg-0">
                <a href="/">Home</a> / <router-link to="/catalog">All</router-link>  / <router-link :to="{path:'/catalog', query:{category: encodeURIComponent(product.first_category)}}">{{product.first_category}}</router-link>  / <router-link :to="{path:'/catalog', query:{category: encodeURIComponent(product.first_category), subcategory: encodeURIComponent(product.first_subcategory)}}">{{product.first_subcategory}}</router-link> /
            </div>
        </div>
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-5 mb-5 mb-md-0">
                    ...
                    <div class="product-colors d-flex flex-wrap">
                        ...
                        <span v-for="color in product.colors" class="color" :style="'background-color:#'+color.hex_code+';'"><!-- --></span>
