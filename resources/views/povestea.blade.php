        ...
        <div class="col-12 pt-5 pad-left pad-right py-5" id="servicii">
            ...
            <div class="row pt-lg-5 margin-bottom">
                <div class="col-mb-8 offset-mb-2 col-xl-6 offset-xl-3 mb-lg-0 d-flex flex-column align-items-center">
                    <h3 class="mb-5"><strong @if (App::isLocale('ro')) lang="en" @endif>Playfully Committed</strong></h3>
                    @if (App::isLocale('ro'))
                    ...
                    @else
                        <p class="text-center playfully-p">Yet, we all know that the unpredictable can play with our plans. We jump in the game with the experience and with all the resources that we have and we enjoy the result. Every time.</p>
                    @endif
                </div>
            </div>
            ...
            <div class="row pt-5">
                ...
                <div class="col-9 col-sm-10 col-xl-4 offset-xl-1 infographic order-1 ofxh">
                    ...
                    @else
                        <p>We help you with the definition of technical specifications and with the experience of the best suppliers in the market.</p>
                    @endif
                    <div data-aos="fade-right" data-aos-duration="500" data-aos-offset="250">
                ...
                <div class="col-9 col-sm-10 col-xl-4 infographic order-3 order-xl-4 ofxh">
                    ...
                    @else
                        <p>We offer integrated solutions that help you, especially when the production process is fragmented.</p>
                    @endif
                ...
                <div class="col-9 col-sm-10 col-xl-4 infographic order-7 order-xl-8 ofxh">
                    ...
                    @else
                        <p>We always deliver on time. In fact, faster, so we can rest assured that you’ve checked this task in your to do list.</p>
                    @endif
            ...
            <div class="row mb-5 ofxh">
                <div class="col-md-9 py-5 pr-4 pad-left bk-green white order-2 order-md-1">
                    ...
                    @else
                        ...
                        <p><strong>Prints?</strong> Yes, digital and offset, indoor and outdoor. <br>What materials do we print on? We’ll use the materials that you suggest or the materials that we consider more suitable for the project described by you. We argue your choice with technical details and description of production limitations if they exist. <br>Yes, we can do the setup in the location. Not only in Bucharest, not only in the country, simultaneously in several locations if necessary.</p>
        ...
        <div class="col-12 margin-top margin-bottom">
            <div class="row">
                <div class="col-xl-5 pad-left pr-5 py-2 margin-bottom">
                    <h4 class="materiale-h4" @if (App::isLocale('ro')) lang="en" @endif>Giveaways</h4>
                    @if (App::isLocale('ro'))
                        <p>Propunem item-uri plecând de la brief-ul tău, ținând cont de culorile de brand, de target și bineînțeles de buget.</p>
                        <p>Importăm materiale promoționale de catalog, facem simulări, ne ocupăm de personalizare și le livrăm acolo unde ai nevoie de ele.<br>
                            Mixăm experiența mai multor furnizori astfel încât produsul custom la care te-ai gândit să iasă chiar mai bine decât l-ai vizualizat.</p>
                    ...
                    @else
                        <p>We make the items proposal considering your brief, the colours of your brand, the target and of course, the budget.</p>
                        <p>We import promotional materials from the catalogues, we make simulations, we take care of the branding and we deliver them where you need them.<br>
                            We mix the experience of several suppliers so that the custom product you thought of will come out even better than you viewed it.</p>
                        <p>We take care of individual packaging if necessary and we prepare the delivery, so that you have enough time for the other tasks from your to do list.</p>
                    @endif
                </div>

                <div class="col-xl-7 mt-3 mt-xl-0">
                    <div class="row">
                        <div class="col-md-6 px-0 giveaway-col"> <img src="{{ asset('img/giveaways_materiale.jpg')}}" class="img-fluid">
                        </div>
                        <div
                            class="col-md-6 d-flex flex-column justify-content-center align-items-center bk-blue giveaway-col">
                            <p class="text-center mb-5 catalog-p">
                                @if (App::isLocale('ro'))
                                    Vezi cele peste 5000 de produse din catalogul nostru.
                                @else
                                    See the more than 5000 products in our catalog.
                                @endif
                            </p>
                            <a @if (App::isLocale('ro')) lang="en" @endif href="{{ route('catalog') }}" class="btn btn-materiale">Go</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 margin-top">
            <div class="row">
                ...
                <div class="col-lg-6 pt-5 pad-right pad-left pl-lg-5 position-relative">
                    <h4 class="materiale-h4 mt-5 mt-lg-0"><span class="materiale-h4-span" @if (App::isLocale('ro')) lang="en" @endif>Creative</span> work and DTP</h4>
        ...
        <div class="col-12 pad-right margin-top margin-bottom">
            <div class="row">
                <div class="col-xl-9 offset-xl-3">
                    <h4 class="call-to-action text-center text-xl-left pl-xl-3 mb-0" @if (App::isLocale('ro')) lang="en" @endif>This is where you call us!</h4>
                </div>
            </div>
        </div>
