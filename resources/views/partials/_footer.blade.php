<footer class="col-12 info-pages-footer">
    <div class="row">
        <div class="col-lg-3 pad-left d-flex align-items-center align-items-md-end align-items-lg-start flex-column flex-md-row flex-lg-column footer-col my-5">
            <img src="{{asset('img/icon_logo_mucca.png')}}" srcset="{{asset('img/icon_logo_mucca.svg')}} 1x" alt="logo-mucca" class="img-fluid mb-lg-5 mr-4 mr-lg-0">
            <div class="social-icons d-flex my-3 my-md-0 mb-lg-5 mr-4 mr-lg-0">
                <a href="#">
                    <img src="{{asset('img/icon_instagram.png')}}" srcset="{{asset('img/icon_instagram.svg')}} 1x" alt="icon-instagram" class="img-fluid mr-2">
                </a>
                <a href="#">
                    <img src="{{asset('img/icon_linkedin.png')}}" srcset="{{asset('img/icon_linkedin.svg')}} 1x" alt="icon-instagram" class="img-fluid">
                </a>
            </div>
            <div class="d-flex flex-column flex-sm-row flex-lg-column">
                <a href="{{route('info')}}" class="mb-lg-2 mr-4 mr-lg-0 text-center text-sm-left">Date de identificare</a>
                <a href="{{route('info')}}" class="mb-lg-2 mr-4 mr-lg-0 text-center text-sm-left">Confidentialitate</a>
                <a href="{{route('info')}}" class="mb-lg-2 mr-4 mr-lg-0 text-center text-sm-left">Cookies</a>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-8 mb-5 mb-xl-0">
                    ...
                    <div class="footer-contacts d-flex justify-content-center justify-content-md-start">
                        <img src="{{asset('img/footer_arrow.png')}}" srcset="{{asset('img/footer_arrow.svg')}} 1x" alt="icon-arrow" class="img-fluid mr-3">
                ...
                <div class="col-xl-3 offset-xl-1 follow-case text-center text-md-left">
                    <p>Follow us</p>
                    <a href="#" class="d-block white">Instagram</a>
                    <a href="#" class="white">Linkedin</a>
                </div>
            </div>
